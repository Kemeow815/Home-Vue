    ...
    <div class="about-modal">
      <div class="about-modal-content">
        ...
        <div class="github-info">
          <h3>开源地址</h3>
          <a href="https://github.com/Kemeow815/Home-Vue" target="_blank" class="github-link">
...
const fetchCommits = async () => {
  try {
    const response = await fetch('https://api.github.com/repos/Kemeow815/Home-Vue/commits');
